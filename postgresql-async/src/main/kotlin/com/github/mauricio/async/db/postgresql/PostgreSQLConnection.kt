...
(
  ...
  override fun disconnect: Future[Connection] = this.connectionHandler.disconnect.map( c => this )
  ...
  override fun sendPreparedStatement(query: String, values: Seq[Any] = List()): Future[QueryResult] = {
    validateQuery(query)
  ...
  private[this] fun notReadyForQueryError(errorMessage : String, race : Boolean) = {
  ...
  private fun setQueryPromise(promise: Promise[QueryResult]) {
