...
object URLParser : AbstractURIParser {
  ...
  override protected fun handleJDBC(uri: URI): Map[String, String] = uri.getSchemeSpecificPart match {
   ...
   * @return
   */
  override protected fun assembleConfiguration(properties: Map[String, String], charset: Charset): Configuration = {
